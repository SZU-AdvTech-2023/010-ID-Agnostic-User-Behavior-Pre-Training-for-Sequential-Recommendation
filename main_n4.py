...
def run_baseline(model, dataset, config_file_list=[]):
    ...
    # bert_model = BERT_Encoder(config)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', '-m', type=str, default='FDSA', help='name of models')
    parser.add_argument('--dataset', '-d', type=str, default='Food', help='name of datasets')
    parser.add_argument('--config_files', type=str, default='props/FDSA.yaml', help='config files')
