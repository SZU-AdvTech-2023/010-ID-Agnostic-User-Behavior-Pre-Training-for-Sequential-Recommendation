...
from baselines.fdsa_improved import FDSA
from data.dataset import UniSRecDataset

def finetune(dataset, pretrained_file, fix_enc=True, model_name=None, **kwargs):
    ...
    if pretrained_file != '':
        ...
        if fix_enc:
            ...
            for _ in model.plm_embedding.parameters():
                _.requires_grad = False
            for _ in model.semantic_transfer_layer.parameters():
                _.requires_grad = False
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', type=str, default='saved/FDSA-Dec-14-2023_15-33-23.pth',
    ...
    finetune(args.d, pretrained_file=args.p, fix_enc=args.f, model_name=args.m)
